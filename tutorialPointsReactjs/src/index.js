...
//ReactDOM.render(<ComponentsApp />, document.getElementById('componentapp'));

//ReactDOM.render(<StateApp />, document.getElementById('stateapp'));

//ReactDOM.render(<PropsOverview headerProp = "Header from props..." contentProp = "Content
//   from props..."/>, document.getElementById('propsoverview'));


//ReactDOM.render(<ComponentLifecycleAPP/>, document.getElementById('componentlifecycleapp'));

//setTimeout(() => {
//   ReactDOM.unmountComponentAtNode(document.getElementById('componentlifecycleapp'));}, 10000);
